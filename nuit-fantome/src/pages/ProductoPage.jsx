...
let productosBase = [
  ...
  // Digitales
  { id:"todo-hk", categoria:"Papelería digital", nombre:"To do list — Hello Kitty", precio:1990,
  ...
  { id:"todo-kuromi", categoria:"Papelería digital", nombre:"To do list — Kuromi", precio:1990,
    img:"/assets/img/to-do-list-kuromi.jpg",
    desc:"To do list imprimible (A4/Letter). Incluye prioridades, tareas, notas, estado de ánimo y consumo de agua." },
  { id:"todo-sailor", categoria:"Papelería digital", nombre:"To do list — Sailor Moon", precio:1990,
    img:"/assets/img/to-do-list-sailor-moon.jpg",
    desc:"To do list imprimible (A4/Letter). Incluye prioridades, tareas, notas, estado de ánimo y consumo de agua." },
  { id:"plan-hk", categoria:"Papelería digital", nombre:"Planner semanal — Hello Kitty", precio:2990,
